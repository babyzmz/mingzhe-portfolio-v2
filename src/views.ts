import {renderContactStream} from './contact-stream.js';
...
export function renderSite(lang:Locale,opts:{singleFile?:boolean}={}):string{
 ...
 <div class="hero-copy"><p class="eyebrow"><i class="status-dot"></i>${t.heroKicker}</p><h1 data-word-reveal>${t.heroA}<br><span>${t.heroB}</span></h1><p class="hero-description" data-word-reveal>${t.heroDesc}</p>
 ...
 <div class="chapter-copy"><p class="eyebrow">${t.fairyKicker}</p><h2 data-fill="cyan">${t.fairyA}<br><span class="accent-cyan">${t.fairyB}</span></h2><p class="chapter-desc" data-word-reveal>${t.fairyDesc}</p>
 ...
 <section class="chapter" id="core" data-scene="2"><div class="chapter-inner"><div class="chapter-copy"><p class="eyebrow">${t.coreKicker}</p><h2 data-fill="neutral">${t.coreA}<br><span class="silver-text">${t.coreB}</span></h2><p class="chapter-desc" data-word-reveal>${t.coreDesc}</p><div class="core-features"><span><b>01</b>${t.coreTag1}</span><span><b>02</b>${t.coreTag2}</span><span><b>03</b>${t.coreTag3}</span></div>${btn('core')}<p class="boundary-note">${t.coreBoundary}</p></div>
 ...
 <section class="chapter" id="mojo" data-scene="3"><div class="chapter-inner"><div class="chapter-copy"><p class="eyebrow">${t.mojoKicker}</p><h2 data-fill="amber">${t.mojoA}<br><span class="accent-amber">${t.mojoB}</span></h2><p class="chapter-desc" data-word-reveal>${t.mojoDesc}</p>
 ...
 <section class="chapter method-chapter" id="method" data-scene="4"><div class="chapter-inner"><div class="chapter-copy"><p class="eyebrow">${t.methodKicker}</p><h2 data-fill="neutral">${t.methodA}<br><span class="silver-text">${t.methodB}</span></h2><p class="chapter-desc" data-word-reveal>${t.methodDesc}</p><div class="tool-pair"><span><i>⌘</i>Codex</span><span><i>✳</i>Claude</span></div><p class="method-quote">${t.methodCallout.replace('\\n','<br>')}</p></div>
 ...
 <section class="work-section light-section" id="work"><div class="section-wrap"><div class="archive-heading"><div><p class="eyebrow">${t.archiveKicker}</p><h2 data-fill="cyan">${t.archiveA}<br><span>${t.archiveB}</span></h2></div><div class="archive-intro"><span class="archive-asterisk" aria-hidden="true">✳</span><p data-word-reveal>${t.archiveDesc}</p></div></div>
 ...
 <section class="about-section" id="about"><div class="section-wrap"><p class="eyebrow">${t.aboutKicker}</p><div class="about-layout"><div class="about-copy"><h2 data-fill="neutral">${t.aboutA}<br><span>${t.aboutB}</span></h2><p data-word-reveal>${t.aboutDesc}</p><p data-word-reveal>${t.aboutDesc2}</p><div class="personal-facts"><span>${t.citizen}</span><span>${t.languages}</span></div><p class="guitar-note"><span>♫</span>${t.guitar}</p><a class="text-button" href="${profile.resume}" download="Mingzhe_Zhang_Resume.pdf">${t.resume}<span>${down}</span></a></div>
